		...
		<div className='p-8 overflow-hidden h-full relative flex items-center justify-center'>
			<div className='flex flex-row flex-shrink-0 justify-center items-center gap-2'>
				<Container className='h-8 w-8 circle-1'>
					<Expo className='h-4 w-4 ' />
				</Container>
				<Container className='h-12 w-12 circle-2'>
					<TypeScript className='h-5 w-5' />
				</Container>
				<Container className='circle-3'>
					<Nextjs className='h-9 w-9' />
				</Container>
...
export const Card = ({
	...
	return (
		<div
			className={cn(
				'w-full rounded-xl bg-bentoCard shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] group',
				className,
			)}
		>
			{children}
	...
	return (
		<div
			className={cn(
				...
				className,
				showGradient &&
					'bg-neutral-700 dark:bg-[rgba(40,40,40,0.70)] [mask-image:radial-gradient(50%_50%_at_50%_50%,white_0%,transparent_100%)]',
			)}
		>
			{children}
		</div>
