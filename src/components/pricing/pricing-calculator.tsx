...
export default function PriceCalculator({
	...
	useEffect(() => {
		const selectedProjectType = projectTypePrices.find(
		...
		const selectedDesign = designOptionPrices.find(
			(option) => option.id === designOption,
		)
		if (selectedDesign) {
											...
											<div className='space-y-6'>
												...
												>
													{projectTypePrices.map((type) => {
														const typeKey =
															type.id as keyof typeof projectTypeTexts
														return (
											...
											<div className='space-y-6'>
												<div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
													{(
														...
														const featureText =
															additionalFeatureTexts[featureTextKey]?.[
																featureSubKey
															]
														return (
															<div
										...
										{currentStep === 2 && (
											<div className='space-y-8'>
												<div>
													...
													>
														{designOptionPrices.map((option) => {
															const optionKey =
																option.id as keyof typeof designOptionTexts
															return (
																<div key={option.id}>
																	<RadioGroupItem
																		value={option.id}
																		...
																		className='peer sr-only'
																		aria-label={
																			designOptionTexts[optionKey].name
																		}
																	/>
																	<Label
												...
												<div>
													<div className='flex justify-between items-center mb-4'>
														<h4 className='text-base font-medium'>
															{pageHeadings.screenCount}
														</h4>
														<span className='text-sm font-medium bg-primary/10 text-primary px-2 py-1 rounded'>
															{screenCount}{' '}
															{screenCount === 1 ? text.screen : text.screens}
														</span>
													</div>
													<Slider
														value={[screenCount]}
												...
												<div className='flex items-center justify-between space-x-2'>
													<div>
														<h4 className='text-base font-medium'>
															{urgentDeliveryText.title}
														</h4>
														<p className='text-sm text-muted-foreground'>
															{urgentDeliveryText.description}
														</p>
													</div>
													<Switch
														id='urgent-delivery'
											...
											<div className='space-y-6'>
												...
												>
													{maintenanceOptionPrices.map((option) => {
														const optionKey =
															option.id as keyof typeof maintenanceOptionTexts
														return (
															<div key={option.id}>
																<RadioGroupItem
																	value={option.id}
																	...
																	className='peer sr-only'
																	aria-label={
																		maintenanceOptionTexts[optionKey].name
																	}
																/>
																<Label
																...
																>
																	<div>
																		...
																		{maintenanceOptionTexts[optionKey]
																			.description && (
																			<div className='text-sm text-muted-foreground'>
																				{
																					maintenanceOptionTexts[optionKey]
																	...
																	<div className='text-sm font-medium'>
																		{option.price > 0
																			? `${formatPrice(option.price)}/${text.perMonth}`
																			: text.noCost}
																	</div>
																</Label>
															</div>
								...
								<div className='space-y-5'>
										...
										<div className='flex items-start'>
											...
											<div>
												...
												<div className='text-sm text-muted-foreground'>
													{
														projectTypeTexts[
															projectType as keyof typeof projectTypeTexts
														]?.name
													}
												</div>
											</div>
													...
													return (
														...
														featureText && (
															...
															>
																...
																<div className='font-medium'>
																	{formatPrice(featurePrice.price)}
																</div>
															</div>
														)
													)
										...
										<div className='flex items-start'>
											...
											<div>
												...
												<div className='text-sm text-muted-foreground'>
													{
														designOptionTexts[
															designOption as keyof typeof designOptionTexts
														]?.name
													}
												</div>
											</div>
									...
									{urgentDelivery && (
										<div className='flex justify-between items-start'>
											...
											<div className='font-medium text-lg text-primary text-right'>
												+30%
											</div>
										</div>
									)}
										...
										<div className='flex justify-between items-center mt-4 pt-4 border-t border-dashed border-border'>
											<div className='flex items-start'>
												...
												<div>
													...
													<div className='text-sm text-muted-foreground'>
														{
															maintenanceOptionTexts[
																maintenanceOption as keyof typeof maintenanceOptionTexts
															]?.name
														}
													</div>
												</div>
											...
											<div className='font-medium text-lg text-right'>
												{formatPrice(
													maintenanceOptionPrices.find(
														(option) => option.id === maintenanceOption,
													)?.price || 0,
												)}
