...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
	return (
		<motion.div
			...
			className={cn(
				'relative z-[60] mx-auto hidden w-full max-w-[90rem] flex-row items-center justify-between gap-4 self-start rounded-full bg-transparent px-4 py-2 lg:flex dark:bg-transparent',
	...
	return (
		...
		>
			...
			<span className='font-bold text-lg'>
				<span className='text-primary'>Oryx</span> Development
			</span>
		</a>
	)
}
...
export const NavbarButton = ({
	...
	const baseStyles =
		'px-4 py-2 rounded-md bg-white button bg-white text-black text-sm relative cursor-pointer inline-block text-center'
